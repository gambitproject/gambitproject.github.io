...
| ---- | ----------------------------------------------------------------- | --------------------- | -------------------------------------------------------------------- |
| 1    | Updating the Gambit GUI                                           | Medium                | GUI, visualization, C++, wxWidgets                                   |
| 2    | GameInterpreter: A front-end for LLM-based game translation tools | Easy/Medium           | LLMs, extensive-form games, front-end                                |
| 3    | A layout algorithm for visualising game trees                     | Hard                  | Extensive-form games, visualization, graph drawing                   |
| 4    | Working on Gambit interoperability with SageMath                  | Easy/Medium           | SageMath, inteoperability, Python                                    |
| 5    | Development and integration of Lemke's algorithm package          | Medium/Hard           | Nash equilibrium, mathematical optimization; linear complementarity  |
| 6    | Updating how Gambit works with external solvers                   | Medium/Hard           | Nash equilibrium, mathematical optimization; interoperability        |
| 7    | New algorithms for finding Nash equilibria                        | Medium/Hard           | Nash equilibrium, algorithms, mathematical optimization 
