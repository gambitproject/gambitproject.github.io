...
> :warning: **2026-03-24 Please note:**  If you are not already in touch with the Gambit team about a GSoC 2026 proposal, unfortunately, at this point in time, and with the extremely large volume of interest this year, we will not be able to engage with you to discuss new proposals. Please feel free to get in contact with us later if you are still in interested in contributing to Gambit.
...
Please use gambit.game.theory@gmail.com to contact us.

We are receiving a very large volume of correspondence at the moment, so please follow this guidance carefully. We request that potential contributors 
provide a CV and short cover letter in the first instance. 
...
We can advise that for this round, we expect that a successful candidate will have **demonstrated prior experience or background** in **game theory** and/or **domains directly relevant to your project proposal**.
If your CV and cover letter does not include this information, we are unlikely to take your candidacy forward, and understand we may not be able to respond to all such enquiries.

**Like many open-source projects, Gambit has documentation with guidance for contributions. We recommend GSoC students review this in advance of submitting any contributions or comments on GitHub, in particular the recently added [New Contributors](https://gambitproject.readthedocs.io/en/latest/developer.contributing.html#a-note-for-new-contributors) and [Policy on AI-Assisted Contributions](https://gambitproject.readthedocs.io/en/latest/developer.contributing.html#policy-on-ai-assisted-contributions) sections.**
...
- [Independent EFG exporter in C++](https://github.com/google-deepmind/open_spiel/blob/master/open_spiel/game_transforms/efg_writer.cc)
