...
form and the extensive form. However, these exporters a) have restrictions and b) are not well documented.
In particular, even though OpenSpiel (and Gambit) supports payoffs at non-terminal nodes, the OpenSpiel
exporters only work if all payoffs are at terminal nodes.
